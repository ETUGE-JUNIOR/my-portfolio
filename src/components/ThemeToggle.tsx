...
export function ThemeToggle({ theme, onToggle }: ThemeToggleProps) {
  ...
  return (
    ...
    >
      <div
        className={`overflow-clip relative rounded-[71.164px] size-full transition-all duration-500 ${
          isDark
      ...
      >
        ...
        {/* Sliding switch ball */}
        <div
          className={`absolute overflow-clip rounded-full size-[66.716px] top-[6.67px] transition-all duration-500 ${
            isDark
