...
export function GlowButton({ children, className = "", ...props }: GlowButtonProps) {
    return (
        ...
        >
            ...
            {/* Content */}
            <span className="relative z-10 flex items-center gap-2 bg-lenear-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent group-hover:from-blue-300 group-hover:via-purple-300 group-hover:to-pink-300 transition-all duration-300">
                <Download /> {children}
            </span>
        </button>
    );
